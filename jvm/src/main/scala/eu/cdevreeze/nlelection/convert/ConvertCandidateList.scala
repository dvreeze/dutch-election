...
object ConvertCandidateList {
  ...
  def parseNestedCandidateList(elem: SaxonNodes.Elem): CandidateList = {
    parseCandidateList(elem.findDescendantElemOrSelf(_.name == ENames.EmlCandidateListEName).get)
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    Using.Manager { use =>
      ...
      val candidateList: CandidateList = parseNestedCandidateList(doc.documentElement)
